...
definition of new web services as trivial as defining a JSON Schema and JSON-LD context
for the desired web services, with basic CRUD support coming for free and basic UI
rendering coming for free as well.
